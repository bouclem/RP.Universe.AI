...
export const enMessages = {
  common: {
    nav: {
      ...
      rpUniverseEngine: "RP Universe Engine",
      create: "Create",
      setup: "Setup",
      welcome: "Welcome",
  ...
  about: {
    ...
    update: {
      ...
      autoChecksDescription: "When enabled, RP.Universe.AI checks for new versions when the app opens.",
  ...
  components: {
    ...
    extra: {
      ...
      dismissAria: "Dismiss",
      v3MessageFallback: "rp-universe-emb-v4 is out and dramatically improves roleplay memory recall. Upgrading is recommended.",
      uploadButton: "Upload",
  ...
  chats: {
    ...
    message: {
      thinkingMessages: {
        ...
        rpUniverseCouncil: "Consulting the RP Universe council…",
  ...
  groupChats: {
    ...
    message: {
      ...
      thinkingRPUniverse: "Consulting the RP Universe council…",
  ...
  hfBrowser: {
    ...
    moveToLibrary: "This model is outside the RP.Universe.AI GGUF library. Move it into the library to keep local models stored in a single location.",
  ...
  backup: {
    ...
    restore: {
      ...
      browseDesc: "Browse for .rpu file",
  ...
  engine: {
    ...
    setup: {
      ...
      completeMessage: "Your RP Universe Engine is configured and ready to go.",
      openDashboard: "Open Dashboard",
    },
    welcome: {
      title: "Welcome to RP Universe Engine",
  ...
  onboarding: {
    ...
    provider: {
      ...
      descriptions: {
        ...
        rpUniverseHost: "Connect to your own desktop RP Universe Host over LAN with OpenAI-style API",
        ...
        custom: "Point RP.Universe.AI to any custom model endpoint",
        fallback: "AI model provider",
      },
      descriptionsShort: {
        chutes: "Open-source model inference",
        openai: "GPT-5, GPT-4o, GPT-4.1",
        rpUniverseHost: "Your own LAN host",
    ...
    model: {
      ...
      setDefaultModelDesc: "Choose which provider and model name RP.Universe.AI should use by default. You'll be able to add more later.",
    ...
    welcome: {
      ...
      restoreBackup: {
        ...
        noBackupsHint: "Tap browse to select a .rpu file",
        browseRPU: "Browse for .rpu file",
    ...
    syncOnboarding: {
      ...
      subtitle: "Pair with a device that already has RP.Universe.AI set up. Your data will be copied over your local network.",
    ...
    modelGuide: {
      ...
      intro: "RP.Universe.AI doesn't force a single \"best\" model. Instead, you pick what fits your <0>use case, budget, and vibe</0>. Use this guide to decide what to try and where to look.",
      ...
      rules: {
        ...
        switch: "If something feels off (too slow / too dumb / too expensive): you can always switch models later in RP.Universe.AI.",
      },
    ...
    whereToFind: {
      badge: "API Key Help",
      intro: "Follow these steps to get your API key, then return to RP.Universe.AI and paste it into the provider settings.",
      ...
      guides: {
        chutes: {
          ...
          s4: "Paste the key into RP.Universe.AI.",
        },
        openai: {
          ...
          s4: "Paste the key into RP.Universe.AI and store it somewhere safe. You will not see it again.",
        },
        anthropic: {
          ...
          s4: "Copy the key and paste it into RP.Universe.AI.",
        },
        openrouter: {
