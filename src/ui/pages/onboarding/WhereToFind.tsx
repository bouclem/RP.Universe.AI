...
const guides: Record<string, Guide> = {
  chutes: {
    ...
    steps: [
      ...
      "Paste the key into RP.Universe.AI.",
    ],
  ...
  openai: {
    ...
    steps: [
      ...
      "Paste the key into RP.Universe.AI and store it somewhere safe. You will not see it again.",
    ],
  ...
  cerebras: {
    ...
    steps: [
      ...
      "Copy the key and paste it into RP.Universe.AI.",
    ],
  ...
  return (
    <div className="flex min-h-screen flex-col bg-black text-white px-4 pb-12 pt-[calc(env(safe-area-inset-top)+12px)]">
      ...
      <p className="mt-2 text-[15px] text-white/65">
        Follow these steps to get your API key, then return to RP.Universe.AI and paste it into the
        provider settings.
      </p>
